...
<div class="container">
    ...
    @endif
    <h1 style="margin: 1rem 1rem">Passport Appointment System</h1>
    <div class="row">
        <td><a href="{{action('PassportController@create')}}" class="btn btn-success" style="padding: 1rem 2rem;margin-bottom: 3rem">Create</a></td>
    </div>
    <div class="row">
